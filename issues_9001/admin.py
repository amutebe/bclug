...
admin.site.register(riskseverity)
admin.site.register(residuerisklikelihood)
admin.site.register(residueriskseverity)
admin.site.register(mod9001_risks)
admin.site.register(approval_status)
admin.site.register(riskmitigation)
admin.site.register(riskdesc)
admin.site.register(mod9001_issues)
